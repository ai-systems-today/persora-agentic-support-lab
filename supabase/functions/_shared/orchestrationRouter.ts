    ...
    signals: [
      {
        ...
        expression: /\b(?:cancel|close|delete)\b.{0,48}\b(?:subscription|membership|account)\b|\b(?:subscription|membership|account)\b.{0,48}\b(?:cancelled|canceled|closed|deleted)\b/i,
      },
